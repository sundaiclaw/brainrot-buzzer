  ...
  return (
    <div className="shell">
      <section className="hero card">
        <div>
          <p className="eyebrow">AI typing punishment chamber</p>
          <h1>Brainrot Buzzer</h1>
          <p className="lede">
            Type cursed meme phrases as fast as you can. Miss a letter and the game hits you with a loud
            buzzer instantly.
          </p>
        </div>
